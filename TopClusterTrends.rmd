...
The trend shows an annual decrease in Acceleration Times of apporximatley 0.004 seconds. 
This is relatively insignificant and general improvements year to year should take care 
of this small time discrepancy. 
...
This analysis shows that there is over a 1.5 second decrease in autocross laptimes year to year. 
...
pte
```
Even though all previous events saw a decrease year to year in times the Endurance times appear to be increasing. 
This is most likely due to course design. This window of data shows a three year cycle where 2014 and 
